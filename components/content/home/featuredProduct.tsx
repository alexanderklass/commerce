...
export default function FeaturedProduct({ product, index }: { product: Product; index: number }) {
  ...
  return (
    <section className={'flex w-full items-center justify-center py-12'}>
      <div className={'flex w-[1400px] flex-col items-center justify-center gap-y-10'}>
        ...
        >
          ...
          ></div>
          <div className={`${index === 0 ? 'border-r-4' : 'border-l-4'} z-10 border-sky-500`}>
            <Image
          ...
          <div className={'z-10 w-[600px]'}>
            ...
            <div>
              <ProductQuickBuyAddToCart selectedVariant={handleVariantStartUpValue()} />
            </div>
          </div>
        </div>
      </div>
